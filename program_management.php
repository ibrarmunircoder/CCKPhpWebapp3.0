...
<?php 
$q1="select * from `feasibility_program`";
$e1=mysqli_query($conn,$q1);

$q2="select * from `banner_program`";
$e2=mysqli_query($conn,$q2);
$result2=mysqli_fetch_row($e2);

$q3="select * from `services_sidebar_program`";
$e3=mysqli_query($conn,$q3);
?>

<div class="site-breadcrumb" style="background: url(assets/img/bg/hero.jpg)">
	<div class="container">
		<h2 class="breadcrumb-title">EV Charging program management</h2>
		<ul class="breadcrumb-menu">
			<li><a href="index.php">Home</a></li>
			<li class="active">EV Charging program management</li>
		</ul>
	</div>
</div>
<?php 
$data1 = mysqli_query($conn,"select * from feasibility_program where id=1");
...
<?php 
$data5 = mysqli_query($conn,"select * from services_sidebar_program where id=1");
        ...
        <div class="row">
            <div class="col-lg-8 col-md-8 mx-auto">
                <div class="site-header text-center mb-40">
                    <span class="site-title-tagline">EV Charging Program Management</span>
                    <h2 class="site-title">Why Conduct an EV Charging Program Management?</h2>
                </div>
            </div>
    	</div>
        <div class="row">
