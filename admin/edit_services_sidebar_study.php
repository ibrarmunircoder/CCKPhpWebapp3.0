...
if(isset($_POST['updateid']))
{
    ...
    $sql="update services_sidebar_study set heading='".$heading."',sub_heading='".$sub_heading."',description='".$description."' where id=$id";
...
if(!empty($_FILES['image']['name'])){
    ...
    $sql="update services_sidebar_study set image='".$image_name."' where id=$id";
    $result=mysqli_query($conn,$sql);
...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit services sidebar study</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <!-- <li class="breadcrumb-item"><a href="all_category.php">Product Listing</a></li> -->
              <li class="breadcrumb-item active">Edit services sidebar study</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <!-- Main content -->
           ...
           <div class="card">
            <div class="card-header">
                <h3 class="card-title">Edit services sidebar study<a href="all_services_sidebar_study.php" class="btn btn-success pull-right"><i class="fa fa-chevron-circle-right fa-1x"></i> All services sidebar study</a></h3>
      ...
      <div class="Data_modal_conts">
                 <?php
                  $sql= mysqli_query($conn,"select * from services_sidebar_study where id='".$id."'");
