...

{
 ...
 $file_name = $_FILES['image']['name'];
   ...
   $newfilename= str_replace(" ", "", basename($_FILES["image"]["name"]));
    ...
    if(empty($errors)==true) {
        ...
        move_uploaded_file($file_tmp, "images/client/" . $newfilename);
 ...
 if(!empty($_FILES['image']['tmp_name'])){
            ...
            $sql="update clients set image='".$newfilename."' where id='".$_GET['id']."'";
            $result=mysqli_query($conn, $sql);

    }

    $sql="update clients set heading='".$heading."',sub_heading='".$sub_heading."' where id='".$_GET['id']."'";
...
<div class="content-header">
      ...
      <!-- Main content -->
           ...
           <div class="card">
            <div class="card-header">
                <h3 class="card-title">Edit Clients <a href="all_clients.php" class="btn btn-success pull-right"><i class="fa fa-chevron-circle-right fa-1x"></i> All Clients</a></h3>
      ...
      <div class="Data_modal_conts">
                 <?php
                            $id=$_GET['id'];
                            $sql= mysqli_query($conn,"select * from clients where id='$id'");
                  ...
                  <input type="hidden" name="id">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2" >
                                            <div class="form-group"><img src="images/client/<?php echo $total['image'];?>"height="110" width="150"></div>
                                        </div>
                                    </div>
