...
$image_name2=$_FILES["image2"]["name"];
    ...
    $q1="INSERT INTO `feasibility_management`(`heading`, `description`, `image1`, `image2`, `image_heading`, `image_description`) VALUES ('$heading','$description','$image_name1','$image_name2','$image_heading','$desc')";
...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Add feasibility management</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <!-- <li class="breadcrumb-item"><a href="all_category.php">Product Listing</a></li> -->
              <li class="breadcrumb-item active">Add feasibility management</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <!-- Main content -->
           ...
           <div class="card">
            <div class="card-header">
                <h3 class="card-title">Add feasibility management<a href="all_feasibility_management.php" class="btn btn-success pull-right"><i class="fa fa-chevron-circle-right fa-1x"></i> All feasibility management</a></h3>
