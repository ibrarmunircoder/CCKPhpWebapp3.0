...
$image_name2=$_FILES["image2"]["name"];
    ...
    $q1="INSERT INTO `feasibility_study`(`heading`, `description`, `image`, `feasibility_image`, `image_heading`, `image_description`) VALUES ('$heading','$description','$image_name1','$image_name2','$image_heading','$desc')";
      ...
      <!-- Main content -->
           ...
           <div class="card">
            <div class="card-header">
                <h3 class="card-title">Add feasibility study<a href="all_feasibility_study.php" class="btn btn-success pull-right"><i class="fa fa-chevron-circle-right fa-1x"></i> All feasibility study</a></h3>
