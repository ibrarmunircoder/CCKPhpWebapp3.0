...
if(isset($_POST['btn1']))
{
    ...
    //upload
    $target_file="images/partners/";
    move_uploaded_file($image, $target_file.basename($image_name));


    $q8="INSERT INTO `partners`(`heading`, `image`) VALUES ('$heading','$image_name')";
      ...
      <!-- Main content -->
           ...
           <div class="card">
            <div class="card-header">
                <h3 class="card-title">Add Partners <a href="all_partners.php" class="btn btn-success pull-right"><i class="fa fa-chevron-circle-right fa-1x"></i> All Partners</a></h3>
