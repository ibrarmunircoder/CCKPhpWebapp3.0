...
if(!empty($_FILES['image1']['name'])){
    ...
    $sql="update banner_management set image1='".$image_name."' where id=$id";
...
if(!empty($_FILES['image2']['name']))
    {
        ...
        $sql="update banner_management set image2='".$image_name2."'";
        $result=mysqli_query($conn,$sql);
    }
    if(!empty($_FILES['image3']['name']))
    {
        ...
        $sql="update banner_management set image3='".$image_name3."'";
        $result=mysqli_query($conn,$sql);
    }
...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Add Banner management </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <!-- <li class="breadcrumb-item"><a href="all_category.php">Product Listing</a></li> -->
              <li class="breadcrumb-item active">Add Banner management </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
     ...
     <div class="card-body">
      <div class="Data_modal_conts">
                                     <?php
                $id=$_GET['id'];
                $sql= mysqli_query($conn,"select * from banner_management where id='$id'  ");
