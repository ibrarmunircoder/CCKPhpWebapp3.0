...
if(isset($_POST['updateid']))
{
    ...
    $sql="update feasibility_study set heading='".$heading."',description='".$description."',image_heading='".$image_heading."',image_description='".$image_description."' where id=$id";
...
if(!empty($_FILES['image1']['name'])){
    ...
    $sql="update feasibility_study set image1='".$image_name."' where id=$id";
    $result=mysqli_query($conn,$sql);
...
if(!empty($_FILES['image2']['name']))
    {
        ...
        $sql="update feasibility_study set image2='".$image_name2."'";
        $result=mysqli_query($conn,$sql);
    }
...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit feasibility study</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <!-- <li class="breadcrumb-item"><a href="all_category.php">Product Listing</a></li> -->
              <li class="breadcrumb-item active">Edit feasibility study</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <!-- Main content -->
           ...
           <div class="card">
            <div class="card-header">
                <h3 class="card-title">Edit feasibility study <a href="all_feasibility_study.php" class="btn btn-success pull-right"><i class="fa fa-chevron-circle-right fa-1x"></i> All feasibility study</a></h3>
      ...
      <div class="Data_modal_conts">
                 <?php
                  $sql= mysqli_query($conn,"select * from feasibility_study where id='".$id."'");
