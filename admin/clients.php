...
if(isset($_POST['btn1']))
{
    ...
    $q5="INSERT INTO `clients`(`heading`, `image`, `sub_heading`) VALUES ('$heading','$image_name','$sub_heading')";
...
else 
{
    if($q5){
        ...
        $msg1="Package  Do not Added...Try Again.";
    }
}
      ...
      <!-- Main content -->
           ...
           <div class="card">
            <div class="card-header">
                <h3 class="card-title">Add Clients <a href="all_clients.php" class="btn btn-success pull-right"><i class="fa fa-chevron-circle-right fa-1x"></i> All Clients</a></h3>
