...
if(isset($_POST['updateid']))
{
    if(!empty($_FILES['image1']['name']))
    {
        ...
        $sql="update banner_study set image1='".$image_name."' where id=$id";
    ...
    if(!empty($_FILES['image2']['name']))
    {
        ...
        $sql="update banner_study set image2='".$image_name2."'";
        $result=mysqli_query($conn,$sql);
    }
    if(!empty($_FILES['image3']['name']))
    {
        ...
        $sql="update banner_study set image3='".$image_name3."'";
        $result=mysqli_query($conn,$sql);
    }
