...
if(isset($_POST['updateid']))
{
    ...
    $sql="update services set heading='".$heading."',sub_heading='".$sub_heading."' where id=$id";
      ...
      <!-- Main content -->
           ...
           <div class="card">
            <div class="card-header">
                <h3 class="card-title">Edit Services <a href="all_services.php" class="btn btn-success pull-right"><i class="fa fa-chevron-circle-right fa-1x"></i> All Services</a></h3>
                  ...
                  <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>">
                                ...
                                <div class="col-md-12">
                                  ...
                                  <div class="row">
                                        ...
                                        <div class="col-md-2" >
                                            <div class="form-group"><img src="images/home/<?php echo $total['image'];?>"height="110" width="150"></div>
                                        </div>
                                    </div>
