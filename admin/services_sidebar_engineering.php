...
if(isset($_POST['btn1']))
{
    ...
    $q2="INSERT INTO `services_sidebar_engineering`(`heading`, `sub_heading`, `image`, `description`) VALUES ('$heading','$sub_heading','$image_name','$image_description')";
...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Services sidebar engineering</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <!-- <li class="breadcrumb-item"><a href="all_category.php">Product Listing</a></li> -->
              <li class="breadcrumb-item active">Services sidebar engineering</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <!-- Main content -->
           ...
           <div class="card">
            <div class="card-header">
                <h3 class="card-title"><a href="all_services_sidebar_engineering.php" class="btn btn-success pull-right">All services sidebar engineering <i class="fa fa-chevron-circle-right fa-1x"></i></a></h3>
