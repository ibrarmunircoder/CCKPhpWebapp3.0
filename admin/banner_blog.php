...
if(!empty($_FILES['image1']['name'])){
    ...
    $sql="update banner_blog set image1='".$image_name."' where id=$id";
...
if(!empty($_FILES['image2']['name']))
    {
        ...
        $sql="update banner_blog set image2='".$image_name2."'";
        $result=mysqli_query($conn,$sql);
    }
    if(!empty($_FILES['image3']['name']))
    {
        ...
        $sql="update banner_blog set image3='".$image_name3."'";
        $result=mysqli_query($conn,$sql);
    }
...
<div class="content-header">
     ...
     <div class="card-body">
      <div class="Data_modal_conts">
                                     <?php
                $id=$_GET['id'];
                $sql= mysqli_query($conn,"select * from banner_blog where id='$id'  ");
