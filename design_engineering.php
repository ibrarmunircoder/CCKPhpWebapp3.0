...
<?php 
$q1="select * from `feasibility_engineering`";
$e1=mysqli_query($conn,$q1);

$q2="select * from `banner_engineering`";
$e2=mysqli_query($conn,$q2);
$result2=mysqli_fetch_row($e2);

$q3="select * from `services_sidebar_engineering`";
$e3=mysqli_query($conn,$q3);
?>

<div class="site-breadcrumb" style="background: url(assets/img/bg/hero.jpg)">
	<div class="container">
		<h2 class="breadcrumb-title">EV Charging design and engineering</h2>
		<ul class="breadcrumb-menu">
			<li><a href="index.php">Home</a></li>
			<li class="active">EV Charging Feasibility design and engineering</li>
		</ul>
	</div>
</div>
<?php 
$data1 = mysqli_query($conn,"select * from feasibility_engineering where id=1");
          ...
          <div class="col-lg-6">
                <div class="about-right">
                    <div class="site-header">
                        <span class="site-title-tagline">feasibility design and engineering</span>
...
<?php 
$data5 = mysqli_query($conn,"select * from services_sidebar_engineering where id=1");
		...
		<div class="row align-items-center">
			<div class="col-lg-4">
				<div class="site-header mb-10">
					<span class="site-title-tagline">An EV Design and Engineering</span>
        ...
        <div class="row">
            <div class="col-lg-8 col-md-8 mx-auto">
                <div class="site-header text-center mb-40">
                    <span class="site-title-tagline">EV Charging Design And Engineering</span>
                    <h2 class="site-title">Why Conduct an EV Charging Design And Engineering?</h2>
                </div>
            </div>
    	</div>
        <div class="row">
