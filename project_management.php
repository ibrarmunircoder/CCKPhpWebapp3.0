...
<?php 
$q1="select * from `feasibility_management`";
$e1=mysqli_query($conn,$q1);

$q2="select * from `banner_management`";
$e2=mysqli_query($conn,$q2);
$result2=mysqli_fetch_row($e2);

$q3="select * from `services_sidebar_management`";
$e3=mysqli_query($conn,$q3);
?>

<div class="site-breadcrumb" style="background: url(assets/img/bg/hero.jpg)">
	<div class="container">
		<h2 class="breadcrumb-title">EV Charging Feasibility Management</h2>
		<ul class="breadcrumb-menu">
			<li><a href="index.php">Home</a></li>
			<li class="active">EV Charging Feasibility Management</li>
		</ul>
	</div>
</div>
<?php 
$data1 = mysqli_query($conn,"select * from feasibility_management where id=1");
          ...
          <div class="col-lg-6">
                <div class="about-right">
                    <div class="site-header">
                        <span class="site-title-tagline">feasibility management</span>
...
<?php 
$data5 = mysqli_query($conn,"select * from services_sidebar_management where id=1");
		...
		<div class="row align-items-center">
			<div class="col-lg-4">
				<div class="site-header mb-10">
					<span class="site-title-tagline">An EV Management</span>
        ...
        <div class="row">
            <div class="col-lg-8 col-md-8 mx-auto">
                <div class="site-header text-center mb-40">
                    <span class="site-title-tagline">EV Charging Feasibility Management</span>
                    <h2 class="site-title">Why Conduct anEV Charging Feasibility Management?</h2>
                </div>
            </div>
    	</div>
        <div class="row">
